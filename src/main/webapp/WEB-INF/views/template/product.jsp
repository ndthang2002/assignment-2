		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="avt" style="width: 50px;height: 40px ; border-radius: 50%;">
						<img src="images/${avt.photo}" width="50"  style="border-radius:100% ;height: 40px;" >
					</div>
				</div>
			</div>
						...
						<ul class="main-menu">
							...
							<div class="dropdown">
								...
								<div class="dropdown-content">
								  ...
								  <a href="/product?loaisanpham=${item.id}">${item.name}</a>
								</c:forEach>
								</div>
